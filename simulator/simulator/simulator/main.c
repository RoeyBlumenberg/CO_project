...
int main(int argc, char *argv[]) {
	FILE *memin,/* *dmemin*/, *diskin, *irq2in, *dmemout, *regout, *trace, *hwregtrace, *cycles, *leds_file, *monitor, *monitor_yuv, *diskout;
	...
	// get intructions memory from memin file and create a struct contains our instruction memory.
	read_memin(memin, Instruction_Memory, &Register_file);
	// pass over the instruction memory
	MEMIN_pass(trace, Instruction_Memory, &Register_file, Data_Memory, irq2in, &Monitor, &Hard_Drive, leds_file, hwregtrace);
